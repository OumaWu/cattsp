    ...
    <div class="w1220">
      <div class="member-sidebar fl">
        ...
        <div class="item">
          ...
          <ul>
            <li> <a href="publishdemands.php" class="">发布需求</a> <a href="mydemands.php" class="on">我的需求</a> </li>
          </ul>
        </div>
      </div>
            ...
            <table width="990" border="1" cellspacing="0" cellpadding="0">
              <tbody>
				...
				<?php
     			...
     			?>
                <tr>
                  <td><a href="demands_detailpage.php?id=<?php echo $res->id; ?>" target="_blank"><?php echo $res->title; ?></a></td>
                  <td><?php echo $res->date; ?></td>
                  <td><?php echo $res->entreprise; ?></td>
                  <td>审核中</td>
                  <td><a style="color: rgb(0, 148, 255);" href="/pub_qiu/fabu_js.aspx?id=34590">编辑</a>&nbsp;|&nbsp;<a id="rpList_ctl00_lbtnDel" style="color: rgb(0, 148, 255);" href="sql/deleteDemand.php?id=<?php echo $res->id; ?>">删  除</a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
