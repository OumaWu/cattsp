...
<!--  信息板块{  -->
<div class="main">
  <div class="xa_bread"> 当前位置： <a href="home.php">首页</a>&nbsp;&gt;&nbsp; <a href="information.php">咨询大厅</a>&nbsp;&gt;&nbsp; <span>详细页</span> 
  </div>
  <div class="xb_l clearfix">
    ...
    <div class="xb_lb">
      ...
      <div class="xb_kc">
        ...
        <p style="text-align: center;"><img width="564" height="284" title="7.jpg" style="width: 564px; height: 284px;" alt="7.jpg" src="子页面/（新闻页面）四川钒钛产业技术交易平台首次线下主题沙龙活动成功举办_四川钒钛产业科技动态_钒钛通_files/1144157648906.jpg"></p>
        <p></p>
      </div>
    </div>
  </div>
