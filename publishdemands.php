...
<!-- 导入技术发布页面css文件{ -->
<link href="./（发布需求）需求发布-会员中心_files/frame.css" rel="stylesheet" type="text/css">
<!-- }导入技术发布页面css文件 -->
    ...
    <div class="w1220">
      <div class="member-sidebar fl">
        ...
        <div class="item">
          ...
          <ul>
            <li> <a href="publishdemands.php" class="on">发布需求</a> <a href="mydemands.php" class="">我的需求</a> </li>
          </ul>
        </div>
      </div>
      <div class="member-main fr">
        ...
        <div class="content">
          ...
          <form id="demand" action="sql/insertDemand.php?userid=<?php echo $_SESSION['userid']; ?>" method="post">
              ...
              <table class="d6xq_tb" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  <tr>
                    <th> <i></i>需求名称： </th>
                    <td><label>
                        <input type="text" class="d6_idtxt" name="title"  id="title" maxlength="50" warning="请填写需求名称">
                      </label></td>
                  </tr>
                  <tr>
                    <th> <i></i>需求介绍： </th>
                    <td><textarea class="d6_tarea" id="description" name="description" warning="请填写需求简介" placeholder="请填写需求简介"></textarea></td>
                  </tr>
                  <tr>
                    <th> <i></i>联系人： </th>
                    <td><label>
                  ...
                  <tr>
                    <th> <i></i>单位名称： </th>
                    <td><label>
                        <input type="text" class="d6_idtxt2" name="entreprise" id="entreprise" maxlength="50" value="">
                      </label></td>
                  </tr>
                  <tr>
                    <th> <i></i>所在地： </th>
