...
<div class="main">
  ...
  <div class="yun_xuqiu_det_a">
    ...
    <div class="yun_xuqiu_det_aa">
      <div class="yun_xuqiu_det_aal"> <span>发布时间：<?php echo $res->date; ?></span>  <span>联系人：XXX经理</span> <br /> <span> 需求企业：<?php echo $res->entreprise; ?> </span> <span>需求地点：<?php echo $res->location; ?></span> </div>
    </div>
  </div>
