...
<div class="main">
  ...
  <div class="xb_bb yun_list_div">
    <ul>
      ...
      <li>
        <div class="xb_bba">
          <p class="title"> <b> <a href="solartech_detailpage.php?id=<?php echo $res->id; ?>" target="_blank"> <?php echo $res->title; ?> </a> </b> </p>
        ...
        <p class="hur2"> <b>技术简介：</b> <em> <?php echo mb_substr($res->description,0,62,"utf-8");?>... </em> <a rel="nofollow" href="solartech_detailpage.php?id=<?php echo $res->id; ?>"_blank">查看详细 &gt;</a> </p>
      </li>
      <?php } ?>
    </ul>
  </div>
  <div class="clear"></div>
  <div class="h_page">
    <div id="pages_bg" class="pages"> <span class="number9"> <span title="上一页">上一页</span><span title="第 1页" class="pagelist_cur">1</span> <a href="#">2</a> <a href="#">3</a> <a href="#">4</a> <a href="#">5</a> <a href="#">6</a> <a href="#">7</a> <span class="more">...</span> <a href="http://www.vtitt.com/tec/list_2.html">下一页</a> 到第
