  ...
  <div class="xb_l clearfix">
    ...
    <div class="xb_lb">
      <ul>
		...
		?>
        <li> <span><?php echo $res->date; ?></span> <a href="information_detailpage.php?news_id=<?php echo $res->id; ?>" target="_blank" class=" chu"> <?php echo $res->title; ?></a> </li>
        <?php } ?>
      </ul>
      <div class="h_page">
        <div id="pages_bg" class="pages"> <span class="number9"> <span title="第 1页" class="pagelist_cur">1</span> 到第
