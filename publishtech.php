    ...
    <div class="w1220">
      <div class="member-sidebar fl">
        ...
        <div class="item">
          ...
          <ul>
            <li> <a href="publishtech.php" class="on">发布技术</a> <a href="mytech.php" class="">我的技术</a> </li>
          </ul>
        </div>
        <div class="item">
            ...
            <div class="wrap1 d6_xqc">
              <table class="d6xq_tb" width="100%" border="0" cellspacing="0" cellpadding="0">
                <tbody>
                  ...
                  <tr>
                    <th> <i></i>技术介绍： </th>
                    <td><textarea class="d6_tarea" id="description" name="description" warning="请填写需求简介" placeholder="填写技术详细介绍"></textarea></td>
                  </tr>
                <th> <i></i>技术图片： </th>
                ...
                <tr>
                  <th> <i></i>单位名称： </th>
                  <td><label>
                      <input type="text" class="d6_idtxt2" name="entreprise" maxlength="50" value="">
                    </label></td>
                </tr>
                <tr>
                  <th> <i></i>所在地： </th>
