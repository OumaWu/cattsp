	...
	function hz6d_cus_web_msg_open(){
		var openurl = "http://www17.53kf.com/webCompany.php?arg=9007654&style=6&kflist=off&kf=3717&zdkf_type=3&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.vtitt.com%2Fcompany%2F&keyword=http%3A%2F%2Fwww.vtitt.com%2F&brief=&logo=&question=&uid=333a03dff92ae93f771a475d47be19ae";
		try{
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<div operating=\"null\" class=\"Lelem\" maxwidth=\"400\" maxheight=\"400\" minwidth=\"100\" minheight=\"100\" style=\"    position: relative; z-index: 10000; cursor: default;\" id=\"acc_title\"><div operating=\" \" class=\"Lelem\" type=\"img\" style=\"display: block; cursor: default; position: absolute; top: 13px; left: 5px; z-index: 10001; width: 412px; height: 217px;\"><img style=\"width: 412px; height: 217px;\" src=\"http://www17.53kf.com/style/setting/ver06/img/icon/logo-skin/common_bg_inv/commonbg_20.png\"></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 24px; left: 14px; z-index: 10002; width: 141px; height: 21px; color: rgb(255, 255, 255);\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 14.7px; line-height: 21px; color: rgb(255, 255, 255); font-family: 宋体; font-weight: bold;\">53KF在线咨询</span></div><div class=\"Lelem\" type=\"img\" operating=\"CLOSE\" style=\"display: block; cursor: pointer; position: absolute; top: 26px; left: 389px; z-index: 10003; width: 12px; height: 12px;\"><img style=\"width: 12px; height: 12px;\" src=\"http://www17.53kf.com/style/setting/ver06/img/icon/logo-skin/close_btn/closebtn_11.png\"></div><div class=\"Lelem\" type=\"img\" style=\"display: block; cursor: default; position: absolute; top: 56px; left: 14px; z-index: 10004; width: 134px; height: 145px;\"><img style=\"width: 134px; height: 145px;\" src=\"http://www17.53kf.com/style/setting/ver06/img/icon/logo-skin/other_img/otherimg_11.png\"></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 66px; left: 163px; z-index: 10005; width: 134px; height: 25px;\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 17.5px; line-height: 25px; font-family: 黑体; font-weight: bold;\">欢迎咨询！</span></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 95px; left: 164px; z-index: 10006; width: 205px; height: 19px;\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 13.3px; line-height: 19px; font-family: 宋体;\">53KF.com，感谢大家的支持！</span></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 119px; left: 165px; z-index: 10007; width: 167px; height: 17px;\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 12px; line-height: 17px; font-family: 宋体;\">请问有什么可以帮您？</span></div><div class=\"Lelem\" type=\"img\" operating=\"KF\" style=\"display: block; cursor: pointer; position: absolute; top: 144px; left: 162px; z-index: 10008; width: 98px; height: 37px;\"><img style=\"width: 98px; height: 37px;\" src=\"http://www17.53kf.com/style/setting/ver06/img/icon/logo-skin/click_btn/clickbtn_45.png\"></div><div class=\"Lelem\" type=\"img\" operating=\"CLOSE\" style=\"display: block; cursor: pointer; position: absolute; top: 144px; left: 285px; z-index: 10009; width: 96px; height: 35px;\"><img style=\"width: 96px; height: 35px;\" src=\"http://www17.53kf.com/style/setting/ver06/img/icon/logo-skin/close_btn/closebtn_17.png\"></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: default; position: absolute; top: 202px; left: 16px; z-index: 10010; width: 110px; height: 17px;\"><a operating=\"HYLINK|http://www.53kf.com|_blank\" style=\"text-decoration: none; cursor: pointer; color: #AAA;\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 10px; line-height: 17px; font-family: 宋体;\">这是什么工具？</span></a></div><div operating=\" \" class=\"Lelem\" type=\"text\" style=\"display: block; cursor: pointer; position: absolute; top: 203px; left: 318px; z-index: 10011; width: 98px; height: 17px;\"><a operating=\"HYLINK|http://www.53kf.com|_blank\" style=\"text-decoration: none; cursor: pointer; color: #AAA;\"><span iseditable=\"1\" style=\"vertical-align: top; font-size: 10px; line-height: 17px; font-family: 宋体;\">Powered by 53KF</span></a></div></div>";
			var is_autoyqk				= "1";
		...
		//	var acc_poptype			 = -1;
			...
			$53.creElm({
				...
				if(1 == 1){
					btn_style1 = 'background: center center no-repeat;background-image: url(http://www17.53kf.com/style/chat/new2017/image/png/img-info24.png);background-image: url(http://www17.53kf.com/style/chat/new2017/image/svg/img-info24.svg), none;'
					btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(http://www17.53kf.com/style/chat/new2017/image/png/img-info36.png);background-image: url(http://www17.53kf.com/style/chat/new2017/image/svg/img-info36.svg), none;'
				}else {
					btn_style1 = 'background: center center no-repeat;background-image: url(http://www17.53kf.com/style/chat/new2017/image/png/img-email24.png);background-image: url(http://www17.53kf.com/style/chat/new2017/image/svg/img-email24.svg), none;'
					btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(http://www17.53kf.com/style/chat/new2017/image/png/img-email36.png);background-image: url(http://www17.53kf.com/style/chat/new2017/image/svg/img-email36.svg), none;'
				...
				if(mini_style_type==1){
					bubble_html = '<div class="mini-btn mini-btn1" id="mini-btn" onclick="show_floatWindow();" style="white-space:nowrap;cursor:pointer;'+mini_btn_display+'position:absolute;'+mini_button_position+'z-index:-1;height: 42px;border-radius:2px; overflow: hidden; background: '+minicolor_tbbj+';-webkit-box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;">'+
										...
										'<div class="mini-btn-window" style="display:inline-block;width: 42px;height: 42px;background: center center no-repeat;background-image: url(http://www17.53kf.com/style/chat/new2017/image/png/to-maxWindow.png);background-image: url(http://www17.53kf.com/style/chat/new2017/image/svg/to-maxWindow.svg), none;"></div>'+
									'</div>';
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="http://www17.53kf.com/img/upload/9007654/mobile/temp/mobile_53kf_1510219533.gif"/>'+
			...
			function show_floatWindow(type){//type:  zdfq:主动发起规则打开  qzzk:强制展开打开   不传:用户点击展开
				...
				// 火狐浏览器 当浮动窗口初始状态为最小化时，展开后输入框获取不到焦点，暂给予刷新处理
				if (navigator.userAgent.indexOf("Firefox") > -1 && acc_pop_type == 2 && show_floatWindow_firefoxRefresh == 1) {
					var iframe = document.getElementById("iframe_company_mini");
					var iframe_src = iframe.getAttribute("src");
					iframe.setAttribute("src",iframe_src);
					show_floatWindow_firefoxRefresh = 0;
				}
	...
	//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑  2017版访客端新增 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
			...
			{
				var openurl = "http://www17.53kf.com/webCompany.php?arg=9007654&style=6&kflist=off&kf=3717&zdkf_type=3&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.vtitt.com%2Fcompany%2F&keyword=http%3A%2F%2Fwww.vtitt.com%2F&brief=&logo=&question=&uid=333a03dff92ae93f771a475d47be19ae&tfrom=2"+force_kf;
				try{
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
                    ...
                    $53("div_company_mini").style.right = '0px';
			     	$53("div_company_mini").style.bottom = '0px';                    $53("mini_header_bg_div").style.backgroundImage = "url('http://www17.53kf.com/style/chat/minichat2/img/header_bg2_1.png')";
				}
				else
				{
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF':
								var click_open_url = 'window.open(\"http://www17.53kf.com/webCompany.php?arg=9007654&style=6&kflist=off&kf=3717&zdkf_type=3&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.vtitt.com%2Fcompany%2F&keyword=http%3A%2F%2Fwww.vtitt.com%2F&brief=&logo=&question=&uid=333a03dff92ae93f771a475d47be19ae&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"http://www17.53kf.com/webCompany.php?arg=9007654&style=6&kflist=off&kf=3717&zdkf_type=3&lnk_overflow=0&language=zh-cn&charset=gbk&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Fwww.vtitt.com%2Fcompany%2F&keyword=http%3A%2F%2Fwww.vtitt.com%2F&brief=&logo=&question=&uid=333a03dff92ae93f771a475d47be19ae&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'http://tb.53kf.com/eht.php?company_id=61423570&style_id=103330707\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
