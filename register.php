          ...
          <div class="left">
            <ul class="register">
              <li>
                ...
                <input class="reginp" type="text" name="accountname" id="accountname" value="" maxlength="15" onfocus="resetDiv();" onblur="checkLogin(this.value);" placeholder="请输入用户名，应为6-15位的英文或数字" />
              </li>
              <li>
                <label><span class="cf50">*</span><b>密码：</b></label>
                <input class="reginp" type="password" name="password" id="password" value="" maxlength="20" placeholder="请输入密码，应为6-20位的英文或数字">
              </li>
              <li>
                <label><span class="cf50">*</span><b>确认密码：</b></label>
                <input class="reginp" type="password" name="pswconfirm" id="pswconfirm" value="" maxlength="20" onblur="checkPsw(this.value);" onfocus="resetDiv2();">
              </li>
              <li>
            ...
            <div class="regbtn"><a class="wys_bluebtn saveClass" href="javascript:void(0);" onclick="checkAll()">立即注册</a></div>
          </div>
        </div>
      </div>
    </form>
