            ...
            <table width="990" border="1" cellspacing="0" cellpadding="0">
              <tbody>
                ...
                <?php
     			...
     			?>
                <tr>
                  <td><a href="solartech_detailpage.php?id=<?php echo $res->id; ?>" target="_blank"><?php echo $res->title; ?></a></td>
                  <td><?php echo $res->date; ?></td>
                  <td><?php echo $res->entreprise; ?></td>
                  <td>审核中</td>
                  <td><a style="color: rgb(0, 148, 255);" href="/pub_qiu/fabu_js.aspx?id=34590">编辑</a>&nbsp;|&nbsp;<a id="rpList_ctl00_lbtnDel" style="color: rgb(0, 148, 255);" href="sql/deleteTech.php?id=<?php echo $res->id; ?>">删  除</a></td>
                </tr>
                <?php } ?>
              </tbody>
            </table>
